...
if (usrn.startsWith("FireC")){
    var ono = create('<strong class="user-name"><span class="username-wrapper"><strong class="user-name"><img src="firec.PNG">' + usrn + '</strong></span><span class="highlight-separator"> - </span><span class="timestamp">Today at ' + hours + ":" + mins +'</span></h2><div class="message-text"><div class="btn-option"></div><div class="markup"><!-- react-text: 12191 -->&nbsp; &nbsp; &nbsp;' + msg + '<!-- /react-text --></div></div></div>');
