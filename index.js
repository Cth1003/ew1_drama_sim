...
setTimeout(function(){ sendnewmsg("FireC", "dextop"); }, 30);
setTimeout(function(){ sendnewmsg("Cth103", "taxbar"); }, 50);
setTimeout(function(){ sendnewmsg("pengu", "@Clyde audit logs pls"); }, 60);
sendnewmsg("pengu", "a");
sendnewmsg("pengu", "aa");
sendnewmsg("pengu", "a");
setTimeout(function(){ sendnewmsg("pengu", "aav"); }, 70);
sendnewmsg("pengu", "aa");
